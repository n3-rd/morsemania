<a href="/game">
	<div
		class="w-[21vw] h-72 bg-white text-black flex justify-center items-center flex-col cursor-pointer"
	>
		<div>
			<svg xmlns="http://www.w3.org/2000/svg" width="92" height="92" viewBox="0 0 32 32"
				><path
					fill="currentColor"
				...
				/><path fill="currentColor" d="M10 16a2 2 0 1 1 2-2a2 2 0 0 1-2 2Zm0-2Z" /><circle
					cx="22"
					cy="12"
					r="1"
					fill="currentColor"
				/><circle cx="22" cy="16" r="1" fill="currentColor" /><circle
					...
					r="1"
					fill="currentColor"
				/><circle cx="24" cy="14" r="1" fill="currentColor" /></svg
			>
		</div>
		<div class="text-[2rem] font-bold">PLAY</div>
	</div>
</a>
